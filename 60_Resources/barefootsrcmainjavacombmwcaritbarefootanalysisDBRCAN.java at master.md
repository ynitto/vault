...
published: null
created: 2026-05-05
description: Java map matching library for integrating the map into software and services
  with state-of-the-art online and offline map matching that can be used stand-alone
  and in the cloud. - barefoot/src/main/java/com/bmwcarit/barefoot/analysis/DBRCAN.java
  at master · bmwcarit/barefoot
tags:
- clippings
- resource/web
- 2026-05
original_source: 00_Inbox/Clippings/barefootsrcmainjavacombmwcaritbarefootanalysisDBRCAN.java
  at master.md
